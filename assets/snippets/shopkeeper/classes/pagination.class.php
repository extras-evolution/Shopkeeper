                ...
                */
                ...
                if($lastpage > 1){
                                if($this->page){
                                                //anterior button
                                                if($this->page > 1)
                                                                $this->pagination .= str_replace('[+link+]',$this->get_pagenum_link($prev),$this->prevT);// "<a href=\"".$this->get_pagenum_link($prev)."\" class=\"prev\">$p</a>";
                                                        else
                                ...
                                if($this->page){
                                                ...
                                                if ($this->page < $counter - 1)
                                                                $this->pagination .= str_replace('[+link+]',$this->get_pagenum_link($next),$this->nextT); //"<a href=\"".$this->get_pagenum_link($next)."\" class=\"next\">$n</a>";
                                                        else
                                                                $this->pagination .= "";
