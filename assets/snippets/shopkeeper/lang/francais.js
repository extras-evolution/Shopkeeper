/* Fichier de langue française de Shopkeeper pour MODx.
   ------------------------------------------------------------------------------
...
langTxt['cookieError'] = "Les cookies doivent être activés dans le navigateur.";
langTxt['delete'] = "Supprimer";
langTxt['delGoods'] = "Retirer produits";
langTxt['goods'] = "produits";
langTxt['count'] = "Quantité";
langTxt['sumTotal'] = "Total :";
langTxt['executeOrder'] = "Envoyer la commande";
langTxt['changeCount'] = "Modifier la quantité";
langTxt['addedToCart'] = "Produit ajouté au panier";
