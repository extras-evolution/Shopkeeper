...
<!-- ьber Registrierung (Kunden - Benutzergruppe) -->
[!Shopkeeper? &orderFormPage=`10`&gotoid=`11`!]
[+phx:mo=`Customers`:then=`[!eForm? &noemail=`0`&formid=`shopOrderForm`&protectSubmit=`0`&tpl=`shopOrderFormWebUser`&report=`shopOrderReportWebUser`&vericode=`0`&ccsender=`1`&subject=`Bestellung`&eFormOnBeforeMailSent=`populateOrderData`&eFormOnMailSent=`sendOrderToManager`!]`:else=`[!eForm? &noemail=`0`&formid=`shopOrderForm`&protectSubmit=`0`&tpl=`shopOrderForm`&report=`shopOrderReport`&vericode=`0`&ccsender=`1`&subject=`Bestellung`&eFormOnBeforeMailSent=`populateOrderData`&eFormOnMailSent=`sendOrderToManager`!]`+]
